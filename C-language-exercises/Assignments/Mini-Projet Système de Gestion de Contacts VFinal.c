...
#include <string.h>
    ...
    void contactTest() 
    {
        const char *noms[] = {"Keltoum", "Marwa", "Salma", "Aya", "Zinb", "Sara", "Anass", "Othmane", "Mohamed", "Ali"};
        long numeros[] = { 623456789, 623456789, 687654321, 611111111, 622222222, 633333333, 663333333, 633233333,  633322333, 633353339  };
        const char *emails[] = { "Keltoumma@gmail.com", "Marwa@gmail.com", "Salma@gmail.com", "Aya@gmail.com", "Zinb@gmail.com", "Sara@gmail.com", "Anass@gmail.com", "Othmane@gmail.com", "Mohamed@gmail.com", "Ali@gmail.com" };
    ...
    int contactExists(char *nom , long numeros , char *email) 
    {
        for (int i = 0; i < Cont; i++) 
        {
            ...
            if (c1[i].NumTele == numeros) 
            {
                return 1;
            }
            if (strcmp(c1[i].Email, email) == 0) 
            {
                return 1;
            }
        }
        ...
        void contact() 
        {
            ...
            if (Cont < 100) 
            {
                ...
                if (contactExists(nom, numero, email)) 
                {
                    printf("\n\e[0;31mErreur : Le contact existe déjà avec ce nom, numéro ou e-mail.\e[0m\n");
                    return;
                }

                c1[Cont].ID = currentID++;
                strcpy(c1[Cont].Nom, nom);
                c1[Cont].NumTele = numero;
                strcpy(c1[Cont].Email, email);
                ...
                Cont++;
                printf("\n\e[0;32mLe contact a été ajouté avec succès !\e[0m\n");
            } 
            else 
            {
